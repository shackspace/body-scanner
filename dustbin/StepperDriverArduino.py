...
class StepperDriver:
	...
	def __init__(self):
		...
		self.enablePin = 8 #Pin to enable data transfer to the Arduino
		self.serialPin1 = 9 #Serial1 of the Arduino
		self.serialPin2 = 10 #Serial2 of the Arduino
		self.statusPin = 20 #Status Pin of the Arduino
